...
(() => {
  ...
  const stylesheet =
    ...
    '  -webkit-user-drag:none;user-select:none;touch-action:pan-y}' +
      // pan-y et non none : avec touch-action:none, un doigt pose sur une
      // photo empechait la page de defiler, le geste etait capte par
      // l'image. Le repositionnement se fait sur .spill, pas ici, donc
      // l'image n'a aucune raison de capter le toucher vertical.
